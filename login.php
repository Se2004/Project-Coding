...
<form action="<?php $_SERVER['SCRIPT_NAME']; ?>" method="POST">
         ...
         <div class="form-group">
                <input type="textbox" name="userBox" class="form-control" placeholder="Имя пользователя">
              </div>
             
              <div class="form-group">
                   <hr>
                <input type="password" name="passBox" class="form-control" placeholder="Пароль">
               </hr>
               </div>
             
              <div class="form-group">
                  <hr>
                <input type="submit" name="submit" value="Войти" class="btn btn-primary py-3 px-5">
                <?php
if(isset($_GET['error'])) {
...
?> 
                ...
                <div class="form-group">
                <a href="register.php" class="btn btn-primary py-3 px-5">Создать аккаунт</a>
              </div> 
            </form>
