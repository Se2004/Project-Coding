...
<div class="form-group">
                <input type="textbox" name="userBox" class="form-control" placeholder="Админ">
              </div>
              ...
              <div class="form-group">
                 <input type="submit" name="submit" value="Войти" class="btn btn-primary py-3 px-5"><?php
                    if(@$_GET['error'] == 1) {
                    echo "<strong>Неверный логин админа или пароль!</strong>";
                    }
                    ?>
</input>
                </div>
